        ...
        *******************************************************************/
		public function QuoteView($quoteId)
        {
            ...
            echo "\t<body>\r\n";
				...
				echo "\t\tCustomer City: ".$QuoteSTMT[customerCity]."<br>\r\n";
				echo "\t\tCustomer Email: ".$QuoteSTMT[customerEmail]."<br>\r\n";
				echo "\t\tProcessing Date: ".$QuoteSTMT[processingDate]."<br>\r\n";
				echo "\t\tCommission: ".$QuoteSTMT[commission]."<br>\r\n";
				echo "\t\tSales Associate: ".$QuoteSTMT[salesAssociate]."<br>\r\n";
				echo "\t\tPrice: ".$QuoteSTMT[currentPrice]."<br>\r\n";

				if ($QuoteSTMT[isFinalized] == "1")
				{
					echo "\t\tStatus: Finalized <br>\r\n";
				}
				elseif  ($QuoteSTMT[isSanctioned] == "1")
				{
					echo "\t\tStatus: Sanctioned <br>\r\n";
				}
